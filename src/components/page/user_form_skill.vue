...
export default {
    computed : mapState({
        WebSkill : state => state.data.WebSkill,
        HouDuanSkill  : state => state.data.HouDuanSkill,
        AndroidSkill : state => state.data.AndroidSkill,
        EvaluationList : state => state.data.EvaluationList,
        SampleNewList : state => state.data.SampleNewList
    }),
    data () {
        return {
            Auth : {
