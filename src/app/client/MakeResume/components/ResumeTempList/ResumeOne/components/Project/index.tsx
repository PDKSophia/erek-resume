      ...
      <ul className={styles.list}>
        <li className={styles.flex}>
          ...
          <div className={styles.text}>
            <ul className={styles.utext}>
              <li className={styles.liname}>
                实现首页主题设置, 接入API，封装请求request, 使用i18n,
                实现中英版本切换
              </li>
              <li className={styles.liname}>
                sessionStorage缓存用户信息, 解决刷新丢失用户数据,
                vuex缓存用户信息，实现数据双向响应
              </li>
              <li className={styles.liname}>
                实现一份信息，多份简历模板，支持PDF打印下载
              </li>
            </ul>
          </div>
        </li>
        <li className={styles.flex}>
          ...
          <div className={styles.text}>
            <ul className={styles.utext}>
              <li className={styles.liname}>
                基于 Vue 2.5 + iView UI
                进行开发，快速搭建后台管理平台，自定义页面
              </li>
              <li className={styles.liname}>
                借鉴模仿 pro-ant-design的设计，适用于小型项目后台管理
              </li>
            </ul>
          </div>
        </li>
